...
from virtual_sketching.rasterization_utils.RealRenderer import GizehRasterizor as RealRenderer
...
def load_dataset_testing(test_dataset, test_path, model_params):
