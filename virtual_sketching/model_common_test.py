import virtual_sketching.rnn as rnn
import tensorflow as tf

from virtual_sketching.subnet_tf_utils import generative_cnn_encoder, generative_cnn_encoder_deeper, generative_cnn_encoder_deeper13, \
